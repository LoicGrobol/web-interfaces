...
**Note** : on peut utiliser JavaScript dans Jupyter via
[Deno](https://docs.deno.com/runtime/reference/cli/jupyter/), mais ce notebook n'a pas été conçu
pour.
...
via [NodeJS](https://nodejs.org) et [Deno](https://deno.com) qui permet de l'utiliser comme un
langage de programmation système ou des plateformes comme [React Native](https://reactnative.dev) ou
...
On peut aussi les mettre sur une même ligne, comme en Python, en les séparant par des `;` **mais on
évite**
...
Il **faut** garder sous la main [la documentation du
...
<input id="elem" type="button" value="Click me">
<script>
  // "remplace la liste des trucs à faire quand quelqu'un clique sur `elem` par la fonction suivante"
...
si de nos jours on n'utilise plus XML pour ça).
